 ...
 */
export function createStatCards(stats: DashboardStats, charts?: DashboardCharts): StatCardData[] {
	return [
		withSub(
...
function withSub(base: Omit<StatCardData, "sub">, sub: string | undefined): StatCardData {
