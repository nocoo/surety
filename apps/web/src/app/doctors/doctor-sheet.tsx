...
const DOCTOR_TITLES = ["主任医师", "副主任医师", "主治医师", "住院医师", "其他"];
...
function DoctorForm({
	...
	const [formData, setFormData] = useState<DoctorFormData>(() => createFormData(doctor));
	const [isSubmitting, setIsSubmitting] = useState(false);
	const [error, setError] = useState<string | null>(null);

	const handleChange = <K extends keyof DoctorFormData>(field: K, value: DoctorFormData[K]) => {
	...
	return (
		<>
			<SheetHeader>
				...
				<SheetDescription>{isEditing ? "修改医生信息" : "添加新的医生"}</SheetDescription>
			</SheetHeader>
