...
function InsurerForm({
	...
	const [formData, setFormData] = useState<InsurerFormData>(() => createFormData(insurer));
	...
	return (
		<>
			<SheetHeader>
				...
				<SheetDescription>{isEditing ? "修改保险公司信息" : "添加新的保险公司"}</SheetDescription>
			</SheetHeader>
			...
			<form onSubmit={onSubmit} className="flex-1 space-y-6 overflow-y-auto px-4 py-6">
				<div className="space-y-4">
					...
					<div className="space-y-2">
						...
						/>
						<p className="text-xs text-muted-foreground">填写官方客服热线，紧急情况下可快速拨打</p>
					</div>
