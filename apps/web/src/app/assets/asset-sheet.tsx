...
function AssetForm({
	...
	const [formData, setFormData] = useState<AssetFormData>(() => createFormData(asset));
	...
	return (
		<>
			<SheetHeader>
				...
				<SheetDescription>{isEditing ? "修改资产信息" : "添加新的资产"}</SheetDescription>
			</SheetHeader>
				...
				<div className="space-y-4">
					...
					<div className="space-y-2">
						...
						<Textarea
							...
							rows={4}
						/>
						<p className="text-xs text-muted-foreground">可选，用于记录额外信息如面积、品牌等</p>
					</div>
				</div>
