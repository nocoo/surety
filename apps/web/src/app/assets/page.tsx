							...
							{assets.length === 0 ? (
								<TableRow>
									<TableCell colSpan={6} className="h-24 text-center">
										<div className="text-muted-foreground">暂无资产，点击「添加资产」开始记录</div>
									</TableCell>
								</TableRow>
							) : (
								assets.map((asset) => {
										...
										<TableRow key={asset.id}>
											<TableCell>
												<div className="flex items-center gap-3">
													<div
														className={`flex h-8 w-8 items-center justify-center rounded-lg ${styleConfig.iconClass}`}
													>
												...
												<div className="flex items-center gap-1">
													...
													<TooltipProvider>
														<Tooltip>
															<TooltipTrigger asChild>
																<span>
																	<Button
																		...
																		aria-label={
																			hasPolicies ? "已有保单关联，无法删除资产" : "删除资产"
																		}
																	>
															...
															{hasPolicies && (
																<TooltipContent>已有保单关联，无法删除</TooltipContent>
															)}
														</Tooltip>
													</TooltipProvider>
												</div>
