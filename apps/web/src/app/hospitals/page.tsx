import { AlertCircle, MapPin, Pencil, Phone, Plus, Trash2, Users } from "lucide-react";
							...
							{filteredHospitals.length === 0 ? (
								...
								filteredHospitals.map((hospital) => (
									<TableRow key={hospital.id}>
										<TableCell>
											<div className="flex items-center gap-2">
												<Avatar className="h-7 w-7">
													<AvatarFallback
														className={cn("text-xs text-white", getAvatarColor(hospital.name))}
													>
										...
										<TableCell>
											<Badge variant={hospital.isPublic ? "default" : "secondary"}>
										...
										<TableCell>
											{hospital.address ? (
												<div className="flex items-center gap-1.5">
													...
													<span className="whitespace-normal">{hospital.address}</span>
												</div>
											) : (
												<span className="text-muted-foreground">-</span>
											)}
											...
											<div className="flex items-center gap-1">
												...
												<TooltipProvider>
													<Tooltip>
														...
														{(hospital.doctorCount ?? 0) > 0 && (
															<TooltipContent>已有医生关联，无法删除</TooltipContent>
														)}
													</Tooltip>
												</TooltipProvider>
											</div>
