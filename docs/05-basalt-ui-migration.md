...
> 不代表当前架构。最新架构请看根目录 README.md 和 AGENTS.md。
...
2. ~~Replace `globals.css` — HSL tokens + 3-tier luminance + Vermilion primary + 24-color palette~~ ✅ `7ea9184`
...
4. ~~Import `palette.ts` + `withAlpha` utility~~ ✅ `8234353`
...
7. ~~Replace Login page with BadgeLogin~~ ✅ `837bcfa`
...
10. ~~Remaining pages styling (coverage-lookup/renewal-calendar/settings)~~ ✅ `277121d`
