 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Drizzle table objects vary by schema definition
...
function getColumnMapping(
	// biome-ignore lint/suspicious/noExplicitAny: Drizzle table column metadata is untyped
	table: any,
	...
	if (columns) {
		for (const [camelKey, col] of Object.entries(columns)) {
			const snakeKey = (col as { name: string }).name;
