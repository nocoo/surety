 ...
 */
export function buildPolicyCards(policies: PolicyForCoverage[]): PolicyCoverageCard[] {
 ...
 */
export function groupPoliciesByCategory(policies: PolicyCoverageCard[]): CategoryGroup[] {
